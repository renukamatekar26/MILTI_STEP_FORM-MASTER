...
const Form = () => {
  ...
  const RegisterUser = async (e) => {
    ...
    try {
      ...
      error.response.status === 403 ? alert('Fill all the fields before submitting') : alert('Registration failed')
      console.log(error);
    }
  ...
  return (
    <div className='bg-gradient-to-r from-slate-100 to-red-600 w-full min-h-full flex flex-col justify-center py-10 sm:px-6 lg:px-8 z-100 '>
      {/* <div>
      </div> */}
      <div className='sm:mx-auto sm:w-full sm:max-w-md'>
         <img className='mx-auto mt-6 h-24 w-auto' src={logo} alt="/" />
